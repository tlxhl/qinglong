...
[task_local]
#东东健康社区
13 1,11,18 * * * https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_health.js, tag=东东健康社区, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=====================Loon================
[Script]
cron "13 1,11,18 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_health.js, tag=东东健康社区

====================Surge================
东东健康社区 = type=cron,cronexp="13 1,11,18 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_health.js

============小火箭=========
东东健康社区 = type=cron,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_health.js, cronexpr="13 1,11,18 * * *", timeout=3600, enable=true
 */
...
const inviteCodes = [
  `T0225KkcR00R9AXSJknwkfVcJgCjVfnoaW5kRrbA@T0205KkcImFHjQq_W12n_rVoCjVfnoaW5kRrbA`,
  `T0225KkcR00R9AXSJknwkfVcJgCjVfnoaW5kRrbA@T0205KkcImFHjQq_W12n_rVoCjVfnoaW5kRrbA`,
  `T0225KkcR00R9AXSJknwkfVcJgCjVfnoaW5kRrbA@T0205KkcImFHjQq_W12n_rVoCjVfnoaW5kRrbA`,
]
...
function readShareCode() {
  console.log(`开始`)
  return new Promise(async resolve => {
    $.get({url: `https://lq.d20q2.cn/jd/health.json`, timeout: 10000}, (err, resp, data) => {
      try {
        if (err) {
