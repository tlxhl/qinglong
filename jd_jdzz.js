...
[task_local]
# 京东赚赚
10 2 * * * jd_jdzz.js, tag=京东赚赚, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdzz.png, enabled=true

================Loon==============
[Script]
cron "10 2 * * *" script-path=jd_jdzz.js,tag=京东赚赚

===============Surge=================
京东赚赚 = type=cron,cronexp="10 2 * * *",wake-system=1,timeout=3600,script-path=jd_jdzz.js

============小火箭=========
京东赚赚 = type=cron,script-path=jd_jdzz.js, cronexpr="10 2 * * *", timeout=3600, enable=true
 */
const $ = new Env('京东赚赚');
