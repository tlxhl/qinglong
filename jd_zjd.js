...
[task_local]
#赚京豆-瓜分京豆
30 0,17 * * * jd_zjd.js, tag=赚京豆-瓜分京豆, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_zjd.png, enabled=true
================Loon==============
[Script]
cron "30 0,17 * * *" script-path=jd_zjd.js, tag=赚京豆-瓜分京豆
===============Surge=================
赚京豆-瓜分京豆 = type=cron,cronexp="30 0,17 * * *",wake-system=1,timeout=3600,script-path=jd_zjd.js
============小火箭=========
赚京豆-瓜分京豆 = type=cron,script-path=jd_zjd.js, cronexpr="30 0,17 * * *", timeout=3600, enable=true
 */
